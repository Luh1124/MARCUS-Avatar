...
from .recon_network_merged import ReconNetWrapper as ReconNetWrapperMerged
from .parametric_face_model import ParametricFaceModel
from .renderer import compute_224projXY_norm_by_pin_hole
from .image_super_utils import imageSuperNet
...
class Face3d_Recon_API(nn.Module):
    ...
    def __init__(self,
                 ...
                 image_super_net_path='./image_super_net.pth',
                 focal=1015.0,
                 camera_distance=10.0,
                 use_merge_model=False,
                 device='cuda'):
        '''
        Args:
            ...
            image_super_net_path: str. The file path of image super net.
        ...
        if use_merge_model:
            self.recon_net = ReconNetWrapperMerged(fc_dim_dict=fc_dim_dict, pretrain_model_path=recon_model_path, device=device)
        else:
        ...
        self.sr_model = imageSuperNet(image_super_net_path)
